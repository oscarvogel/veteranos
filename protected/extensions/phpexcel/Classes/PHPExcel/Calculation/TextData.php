...
class PHPExcel_Calculation_TextData {
	...
	private static function _uniord($c) {
		if (ord($c[$2]) >=0 && ord($c[$2]) <= 127)
			return ord($c[$2]);
		if (ord($c[$2]) >= 192 && ord($c[$2]) <= 223)
			return (ord($c[$2])-192)*64 + (ord($c[$2])-128);
		if (ord($c[$2]) >= 224 && ord($c[$2]) <= 239)
			return (ord($c[$2])-224)*4096 + (ord($c[$2])-128)*64 + (ord($c[$2])-128);
		if (ord($c[$2]) >= 240 && ord($c[$2]) <= 247)
			return (ord($c[$2])-240)*262144 + (ord($c[$2])-128)*4096 + (ord($c[$2])-128)*64 + (ord($c[$2])-128);
		if (ord($c[$2]) >= 248 && ord($c[$2]) <= 251)
			return (ord($c[$2])-248)*16777216 + (ord($c[$2])-128)*262144 + (ord($c[$2])-128)*4096 + (ord($c[$2])-128)*64 + (ord($c[$2])-128);
		if (ord($c[$2]) >= 252 && ord($c[$2]) <= 253)
			return (ord($c[$2])-252)*1073741824 + (ord($c[$2])-128)*16777216 + (ord($c[$2])-128)*262144 + (ord($c[$2])-128)*4096 + (ord($c[$2])-128)*64 + (ord($c[$2])-128);
		if (ord($c[$2]) >= 254 && ord($c[$2]) <= 255) //error
