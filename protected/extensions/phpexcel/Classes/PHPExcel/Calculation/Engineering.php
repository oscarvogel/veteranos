...
class PHPExcel_Calculation_Engineering {
	...
	public static function _parseComplex($complexNumber) {
		...
		if (strlen($workString) > 0) {
			$leadingSign = (($workString[$2] == '+') || ($workString[$2] == '-')) ? 1 : 0;
		}
		$power = '';
	...
	private static function _cleanComplex($complexNumber) {
		if ($complexNumber[$2] == '+') $complexNumber = substr($complexNumber,1);
		if ($complexNumber[$2] == '0') $complexNumber = substr($complexNumber,1);
		if ($complexNumber[$2] == '.') $complexNumber = '0'.$complexNumber;
		if ($complexNumber[$2] == '+') $complexNumber = substr($complexNumber,1);
