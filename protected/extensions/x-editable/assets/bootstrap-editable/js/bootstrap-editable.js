...
(function ($) {
    ...
    //Bootstrap 3 compat: ensure popover.defaults exists before we read .template
    if (!$.fn.popover) {
        $.fn.popover = { defaults: { template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>' } };
    } else if ($.fn.popover.DEFAULTS && !$.fn.popover.defaults) {
        $.fn.popover.defaults = $.fn.popover.DEFAULTS;
    }
    ...
    $.extend($.fn.editableContainer.Constructor.prototype, {
        ...
        //Bootstrap 3 stores popover as 'bs.popover', Bootstrap 2 uses 'popover'
        container: function() {
            return this.$element.data('bs.popover') || this.$element.data(this.containerName);
        },
