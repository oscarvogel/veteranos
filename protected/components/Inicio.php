...
class Inicio
{
	static $EsMovil = false;
	
	public static function Preparar()
	{
		//include(Yii::app()->baseUrl . "/components/Mobile_Detect.php");
		$detect = new Mobile_Detect();
		if ($detect->isMobile() or $detect->isTablet()) {
            Yii::app()->theme = "mobile";
            self::$EsMovil = true;
            Yii::app()->params['EsMovil'] = true;
		}else{
            Yii::app()->theme = "hebo";
            self::$EsMovil = false;
            Yii::app()->params['EsMovil'] = FALSE;
	...
	{
		//return $detect->isMobile() or $detect->isTablet();
		return true;
	}
}
?>
