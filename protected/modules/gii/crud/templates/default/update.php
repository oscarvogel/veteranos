...
$this->menu=array(
	...
	array('label'=>'<?php echo Yii::t('app','View');?> <?php echo $this->modelClass; ?>', 'url'=>array('view', 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
	array('label'=>'<?php echo Yii::t('app','Manage');?> <?php echo $this->modelClass; ?>', 'url'=>array('admin')),
);
?>

<h1><?php echo Yii::t('app','Update');?> <?php echo $this->modelClass." <?php echo \$model->{$this->tableSchema->primaryKey}; ?>"; ?></h1>
